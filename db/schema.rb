...
ActiveRecord::Schema.define(version: 20160610084924) do
  ...
  add_index "likings", ["likeable_type", "likeable_id"], name: "index_likings_on_likeable_type_and_likeable_id", unique: true
