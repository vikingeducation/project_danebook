...
describe CommentsController do
  ...
  let(:post_comment) { create(:comment, commenter_id: user.id, commentable_type: "Post", commentable_id: user_post.id) }
  ...
  context "Logged In" do
    ...
    describe "POST #create" do
      it "creates a new comment from valid attributes" do
        expect {
          post :create, params: { user_id: user.id, post_id: user_post.id, commentable: "Post", comment: attributes_for(:comment) }
